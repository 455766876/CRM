...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#saveRemarkBtn").click(function () {
                $.ajax({
                    ...
                    dataType: "json",
                    type: "post",
                    success: function (data) { // 返回 success修改是否成功，一个备注
                        if (data.success) {
                            // 新增一个备注的div
                            var html = '';
                            ...
                            // html += '<h5 id="' + data.remark.id + 'noteContent">' + remark.noteContent + '</h5>';
                            html += '<h5 id="h' + data.remark.id + '">' + data.remark.noteContent + '</h5>';
                            ...
                            html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\'' + data.remark.id + '\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: skyblue;"></span></a>';
                            html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                            html += '<a class="myHref" href="javascript:void(0);" onclick="deleteRemark(\'' + data.remark.id + '\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: skyblue;"></span></a>';
                            html += '</div>';
                            html += '</div>';
                            html += '</div>';
            ...
            $("#updateRemarkBtn").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            // 修改id=id+noteContent 的div的内容
                            $("#" + id + "noteContent").html(data.remark.noteContent);
                            // 将 修改时间和修改人添加上
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, element) {
                        ...
                        html += '<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
                        html += '<div style="position: relative; top: -40px; left: 40px;">';
                        html += '<h5 id="' + element.id + 'noteContent">' + element.noteContent + '</h5>';
                        ...
                        html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                        html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\'' + element.id + '\')" ><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: skyblue;"></span></a>';
                        html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                        html += '<a class="myHref" href="javascript:void(0);" onclick="deleteRemark(\'' + element.id + '\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: skyblue;"></span></a>';
                        html += '</div>';
                        html += '</div>';
                        html += '</div>';
                    });
        ...
        function editRemark(id) {
            $("#noteContent").val($("#" + id + "noteContent").text());
            // 将id赋值给隐形域
            $("#remarkId").val(id);
