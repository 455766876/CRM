    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#searchBtn").click(function () {
                ...
                $("#hidden-clueSource").val($("#edit-clueSource").val().trim())
                $("#hidden-customerId").val($("#search-customerId").val().trim())
                $("#hidden-fullname").val($("#search-fullname").val().trim())
                $("#hidden-birth").val($("#search-birth").val().trim())
            ...
            $("#contactsBody").on("click", $("input[name=dx]"), function () {
        ...
        function pageList(pageNo, pageSize) {
            ...
            $("#edit-clueSource").val($("#hidden-clueSource").val().trim())
            $("#search-customerId").val($("#hidden-customerId").val().trim())
            $("#search-fullname").val($("#hidden-fullname").val().trim())
            $("#search-birth").val($("#hidden-birth").val().trim())
            ...
            $.ajax({
                ...
                data: {
                    ...
                    "source": $("#edit-clueSource").val().trim(),
                    "customerId": $("#search-customerId").val().trim(),
                    "fullname": $("#search-fullname").val().trim(),
                    "birth": $("#search-birth").val().trim()
                },
                dataType: "json",
                // type:"post",
                success: function (data) {
                    ...
                    $.each(data.dataList, function (i, e) {
                        ...
                        html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'detail.html\';">' + e.fullname + '</a></td>';
